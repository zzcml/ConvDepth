...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 depths: list=[3, 3, 9, 3], dims:list=[96, 192, 384, 768], drop_path_rate: float=0.,
...
def convnext_tiny(pretrained=True, in_22k=True, **kwargs):
    ...
    model.head=nn.Linear(768,21841)
    if pretrained:
...
def convnext_base(pretrained=True, in_22k=True, **kwargs):
    ...
    model.head = nn.Linear(1024, 21841)
    if pretrained:
...
def convnext_large(pretrained=True, in_22k=True, **kwargs):
    ...
    model.head = nn.Linear(1536, 21841)
    if pretrained:
...
def convnext_xlarge(pretrained=True, in_22k=True, **kwargs):
    ...
    model.head = nn.Linear(2048, 21841)
    if pretrained:
